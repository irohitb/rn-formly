  ...
  const selectImage = async () => {
    try {
      ...
      if (Array.isArray(imageDocRecieved)) {
        throw new Error(
          'Bug in rn-formly library, Expected single image but recieved multiple Image'
        );
      }
  ...
  if (!value) {
    return (
      <View style={styles.mainImageContainer}>
        ...
        >
          <Text style={[styles.TextPlusSign, { color: defaultColor }]}>
            {' '}
            +{' '}
          </Text>
        </TouchableOpacity>
        ...
        {imageValue.map((el, index) => {
          if (el) {
            ...
            return (
              ...
              >
                <Text
                  style={[styles.multipleImagePlus, { color: defaultColor }]}
                >
                  +
                </Text>
              </TouchableOpacity>
