...
export type OTPprops = OTPBaseProps & Partial<NextInputProps>;
...
export interface AutoCompleteBaseProps {
  upsideEmit: (
    val: AutoCompleteObj | null | string,
    selection: boolean,
...
export type DateTyperProps = DateTyperBase & Partial<NextInputProps>;
